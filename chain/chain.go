...
func (c *RPCClient) onRecvTx(tx *vtcutil.Tx, block *btcjson.BlockDetails) {
...
func (c *RPCClient) onRedeemingTx(tx *vtcutil.Tx, block *btcjson.BlockDetails) {
...
out:
	for {
		...
		case <-pingChan:
			...
			// https://github.com/btcsuite/vtcd/issues/504).  Decrease this to
